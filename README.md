...
[![Build Status](
https://travis-ci.org/libern/ClickhouseBuilder.svg?branch=master)](https://travis-ci.org/libern/ClickhouseBuilder) [![Coverage Status](https://coveralls.io/repos/github/libern/ClickhouseBuilder/badge.svg?branch=master)](https://coveralls.io/github/libern/ClickhouseBuilder?branch=master)
...
```bash
composer require libern/clickhouse-builder
```
